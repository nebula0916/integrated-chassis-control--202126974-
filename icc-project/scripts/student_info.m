...
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.
    ...
    info.student_id   = '202126974';
    info.name         = '이건웅';
    info.team_members = {struct('id','202220917','name','조민서')};   % 2인 팀이면 {struct('id','...','name','...')} 추가
    ...
    info.ai_usage = 'Gemini & Claude :For Gain Coordination & Controller Recommendation & State Space study';
